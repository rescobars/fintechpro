...
const getVariantClasses = (variant: ButtonVariant = 'primary') => {
  switch (variant) {
    ...
    case 'outline':
      return 'border border-blue-600 text-blue-600 hover:bg-blue-50 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2';
    case 'text':
      return 'text-blue-600 hover:bg-blue-50 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2';
  }
};
